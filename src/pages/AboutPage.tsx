...
import StemCer from "@/assets/StemCer.jpg";
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16 animate-fade-in-up">
              <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6">
                Our <span className="bg-gradient-button bg-clip-text text-white">Mission</span>
              </h2>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="animate-scale-in">
                <div className="bg-gradient-accent rounded-3xl p-8 text-white">
                                  <img
                                      src={StemCer}
                                      alt="Beyond Reality School STEM Certificate"
